...
public class BusNo extends Step<String> {
    private static final int MIN_CHARACTERS_ALARM_NAME = 4;

    private TextInputEditText alarmNameEditText;
    private String unformattedErrorString;

    public BusNo(String title) {
        this(title, "");
    }

    public BusNo(String title, String subtitle) {
