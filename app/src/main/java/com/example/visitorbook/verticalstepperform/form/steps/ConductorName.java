...
public class ConductorName extends Step<String> {
    ...
    public ConductorName(String title) {
        this(title, "");
    }

    public ConductorName(String title, String subtitle) {
    ...
    protected View createStepContentLayout() {
        ...
        alarmNameEditText.setHint("Conductor Name (required)");
