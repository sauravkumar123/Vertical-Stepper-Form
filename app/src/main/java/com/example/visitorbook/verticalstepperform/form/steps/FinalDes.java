...
public class FinalDes extends Step<String> {
    ...
    public FinalDes(String title) {
        this(title, "");
    }

    public FinalDes(String title, String subtitle) {
    ...
    protected View createStepContentLayout() {
        ...
        alarmNameEditText.setHint("Final Destination (required)");
