...
public class traversName extends Step<String> {
    ...
    public traversName(String title) {
        this(title, "");
    }

    public traversName(String title, String subtitle) {
    ...
    protected View createStepContentLayout() {
        ...
        alarmNameEditText.setHint("Traveling Name");
