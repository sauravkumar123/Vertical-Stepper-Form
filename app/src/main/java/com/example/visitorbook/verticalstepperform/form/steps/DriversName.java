...
public class DriversName extends Step<String> {
    ...
    public DriversName(String title) {
        this(title, "");
    }

    public DriversName(String title, String subtitle) {
    ...
    protected View createStepContentLayout() {
        ...
        alarmNameEditText.setHint("Driver's Name (required)");
